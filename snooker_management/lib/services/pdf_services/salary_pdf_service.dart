...
class SalaryPdfService {
  static Future<Uint8List> generatePdf({
    required List<SalaryModel> salries,
  ...
  static pw.Widget _buildTable(List<SalaryModel> data, pw.Font font) {
    return pw.Table(
      ...
      children: [
        ...
        ...data.map((e) => pw.TableRow(
              children: [
                ...
                _cell(e.employeeSalary.toString(), font),
                _cell(e.shift ?? "", font),
