...
AllocationModel allocationModelFromJson(String str) => AllocationModel.fromJson(json.decode(str));

String allocationModelToJson(AllocationModel data) => json.encode(data.toJson());
