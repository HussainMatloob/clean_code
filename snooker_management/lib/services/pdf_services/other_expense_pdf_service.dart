...
class OtherExpensePdfService {
  static Future<Uint8List> generatePdf({
    required List<dynamic> otherExpenses,
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          _buildTable(otherExpenses, helvetica),
        ],
      ),
    );
    ...
    return pw.Table(
      ...
      children: [
        ...
        ...data.map((e) => pw.TableRow(
              children: [
                _cell(e.name?.toString() ?? "", font),
                _cell(e.expenseName ?? "", font),
                _cell((e.otherExpenseAmount ?? 0).toString(), font),
                _cell(
                    e.expenseDate != null
