...
class SalaryPdfPreviewPage extends StatefulWidget {
  const SalaryPdfPreviewPage({
    super.key,
  });

  @override
  State<SalaryPdfPreviewPage> createState() => _AllocationPdfScreenState();
}

class _AllocationPdfScreenState extends State<SalaryPdfPreviewPage> {
