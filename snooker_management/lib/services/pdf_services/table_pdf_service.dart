...
class TablePdfService {
  static Future<Uint8List> generatePdf({
    required List<TableDetailModel> tables,
  ...
  static pw.Widget _buildTable(List<TableDetailModel> data, pw.Font font) {
    return pw.Table(
      ...
      children: [
        ...
        ...data.map((e) => pw.TableRow(
              children: [
                _cell(e.tableNumber, font),
                _cell(e.tableName, font),
                _cell(e.tableType, font),
                _cell(e.tableDescription, font),
                _cell(e.tablePrice, font),
              ],
            ))
      ],
    );
