...
class OtherExpensesPdfPreviewPage extends StatelessWidget {
                ...
                return pw.Column(
                  children: [
                    ...
                    pw.Table.fromTextArray(
                      headers: ['Name', 'Expense Name', 'Amount', "Date"],
                      ...
                      data: currentPageData.map((otherExpenses) {
                        return [
                          otherExpenses.name,
                          otherExpenses.expenseName.length > 80
                              ? '${otherExpenses.expenseName.substring(0, 80)}...'
                              : otherExpenses.expenseName,
                          otherExpenses.otherExpenseAmount,
                          expensesController
                              .formatDate(otherExpenses.expenseDate!),
                        ];
                      }).toList(),
                    ),
                  ],
